...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Master Divisi</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="staticBackdropLabel"><?= $row['division_name'];?></h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <p><?= $row['division_desc'];?></p>
                                                                </div>
                                                                <div class="modal-footer">
                                                              
                                                                <a href="divisi/edit/<?= $row['id'];?>" class="btn btn-primary">Edit</a>
                                                                <a href="divisi/delete/<?= $row['id'];?>" class="btn btn-danger">Delete</a>
