        ...
        <div class="row">
            <div class="col">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="/bankAccount/update" method="post" >
                        <div class="card-body">
                            <div class="form">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter ..." name="bank_cd" value="<?= $data->bank_code; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    <div class="form-group">
